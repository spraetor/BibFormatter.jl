...
"""Format names as 'First von Last' list with BibTeX-style separators."""
function formatNames(out::Output, names::BibInternal.Names)::String
  outstr = ""
  numnames = length(names)
  for (i, n) in enumerate(names)
    t = formatNameFirstLast(out.fmt, n.particle, n.last, n.junior, n.first, n.middle) # {ff~}{vv~}{ll}{, jj}
    if i > 1
      if numnames - i > 0
        outstr *= ", " * t
      else
...
function formatDate(out::Output, data::BibInternal.Entry)::String
  if empty(data.date.year)
    ...
    return empty(data.date.month) ? data.date.year : replaceMonthName(data.date.month) * " " * data.date.year
  end
end
...
function article(fmt::OutputFormat, data::BibInternal.Entry)
  ...
  newBlock!(out)
  outputCheck!(out, emphasize(fmt, replaceJournalNames(data.in.journal)), "Empty 'journal' in $(data.id).")
...
end # module BibliographyStylePlain
...
# This is a note.
function formatArticle(fmt::OutputFormat, style::Plain, data::BibInternal.Entry)
  BibliographyStylePlain.article(fmt, data)
end
...
# This is a note.
function formatBook(fmt::OutputFormat, style::Plain, data::BibInternal.Entry)
  BibliographyStylePlain.book(fmt, data)
end
...
# Publisher, Address, edition edition, mm yyyy.
# This is a note.
function formatBooklet(fmt::OutputFormat, style::Plain, data::BibInternal.Entry)
  BibliographyStylePlain.booklet(fmt, data)
end
...
# Publisher, Address, edition edition, mm yyyy.
# This is a note.
function formatInBook(fmt::OutputFormat, style::Plain, data::BibInternal.Entry)
  BibliographyStylePlain.inbook(fmt, data)
end
...
# Publisher, Address, edition edition, mm yyyy.
# This is a note.
function formatInCollection(fmt::OutputFormat, style::Plain, data::BibInternal.Entry)
  BibliographyStylePlain.incollection(fmt, data)
end
...
# This is a note.
function formatManual(fmt::OutputFormat, style::Plain, data::BibInternal.Entry)
  BibliographyStylePlain.manual(fmt, data)
end
...
# This is a note.
function formatMastersThesis(fmt::OutputFormat, style::Plain, data::BibInternal.Entry)
  BibliographyStylePlain.mastersthesis(fmt, data)
end
...
# This is a note.
function formatMisc(fmt::OutputFormat, style::Plain, data::BibInternal.Entry)
  BibliographyStylePlain.misc(fmt, data)
end
...
# Type, School, Address, mm yyyy.
# This is a note.
function formatPhDThesis(fmt::OutputFormat, style::Plain, data::BibInternal.Entry)
  BibliographyStylePlain.phdthesis(fmt, data)
end
...
# This is a note.
function formatProceedings(fmt::OutputFormat, style::Plain, data::BibInternal.Entry)
  BibliographyStylePlain.proceedings(fmt, data)
end
...
# This is a note.
function formatTechreport(fmt::OutputFormat, style::Plain, data::BibInternal.Entry)
  BibliographyStylePlain.techreport(fmt, data)
end

# F. M. Last1, F. M. Last2, and F. M. Last3.
# Title.
# This is a note, mm yyyy.
function formatUnpublished(fmt::OutputFormat, style::Plain, data::BibInternal.Entry)
  BibliographyStylePlain.unpublished(fmt, data)
end
